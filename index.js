...
router.get('/get/html', function(req, res) {
    ...
    let xml = fs.readFileSync('EricHair.xml', 'utf8'),
        xsl = fs.readFileSync('EricHair.xsl', 'utf8');
...
router.post('/post/json', function (req, res) {
    ...
    function appendJSON(obj) {
        ...
        XMLtoJSON('EricHair.xml', function (err, result) {
            if (err) throw (err);
            ...
            JSONtoXML('EricHair.xml', result, function(err){
