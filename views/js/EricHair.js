...
function highlightstudent(idTable, bShowVeg) {
    ...
    // "student" attribute on it.
    for (i = 0; i < aTRs.length; i++) {
        if (aTRs[i].getAttribute('student') && aTRs[i].getAttribute('student') == "true") {
            if (bShowVeg) {
                aTRs[i].style.backgroundColor = "lightRed";
            } else {
